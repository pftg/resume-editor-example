<template>
  <div>
    <div id="header">
      <div class="flex bg-white border-gray-200 fixed top-0 inset-x-0 z-100 h-16 items-center">
        <div class="w-full max-w-screen-xl relative px-6 h-full">
          <div class="flex -mx-6 h-full">
            <div class="lg:w-40 pl-6 pr-6 lg:pr-8 text-white bg-indigo-100">
            ...
            <div class="flex flex-grow lg:w-3/4 xl:w-4/5 bg-white h-full items-center">
              <div class="w-full lg:px-6 xl:px-12">
                ...
                <div class="w-full block hidden flex-grow lg:flex lg:items-center lg:w-auto md:block">
    ...
    <div class="w-full max-w-screen-xl px-6">
      <div class="lg:flex -mx-6">
        <div id="sidebar"
          ...
          <div id="navWrapper"
               class="h-full overflow-y-auto scrolling-touch
               lg:h-auto lg:block lg:relative lg:sticky lg:bg-transparent
               inset-x-0 top-0 pt-16"
          >
            <nav id="nav"
        ...
        <div id="content-wrapper bg-gray-400"
          ...
          <div id="content">
            <div id="_app" class="flex ">
              <div class="pt-24 pb-16 lg:pt-28 w-full">
                <div class="flex">
                  <div class="markdown px-6 xl:px-12 w-full mx-auto lg:ml-0 lg:mr-auto xl:mx-0 xl:w-1/4">
                    <router-view/>
                  </div>
