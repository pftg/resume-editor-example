<template>
  <div class="card relative" v-focus data-cy="experience-item">
    ...
    <draggable :list="job.highlights" group="highlights" @start="drag=true" @end="drag=false" handle=".handle">
      <div :key="index" class="flex items-center justify-between mb-4" v-for="(highlight, index) in
      job.highlights">
        <svg class=" h-6 w-6 handle cursor-move" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24"
          height="24">
          <path class="heroicon-ui"
            d="M4 5h16a1 1 0 0 1 0 2H4a1 1 0 1 1 0-2zm0 6h16a1 1 0 0 1 0 2H4a1 1 0 0 1 0-2zm0 6h16a1 1 0 0 1 0 2H4a1 1 0 0 1 0-2z" />
        </svg>
        <Highlight :highlight="highlight" class="w-full ml-3" />
        <button class="ml-3 h-6 w-6" @click="removeHighlight({ job, highlight })"  data-cy="delete-highlight">
    ...
    <button @click="removeJob(job)" ref="deleteJob" data-cy="delete-job"
